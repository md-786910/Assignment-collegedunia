        ...
        <>
            <div className="header_bg">
                <img
                    ...
                    data-src="https://cdn.zoutons.com/images/home/biscuit_new.jpg"
                    alt="home"
                    src="https://cdn.zoutons.com/images/home/biscuit_new.jpg"
                />
            </div>
            <header>
                <div className="page clearfix">
                    ...
                    <div className="head_right">
                        {
                            user?.token && <span id="login_link_profile" className="btn btn-big ">
                                <span>
                                    <svg
                                        width="18"
                                        height="18"
                                ...
                                <span
                                    className="js-loggedin-username"
                                    style={{
                                        marginLeft: '5px',
                                        textAlign: 'left',
                                ...
                                <div className="dropdown">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <form id="logout_form" style={{
                                                display: 'none'
                                            }}>
                                                <input
                                                    type="hidden"
                                                    name="_token"
                                                    value="eCqLKQyvofEj8BCBekVfRiUdGTTA109foxORDnAx"
                                                />
                                            </form>
                                        </li>
                                    </ul>
                        ...
                        {
                            !user?.token && <span id="js_logout_link" className="btn btn-big btn-primary" onClick={() => handleOpen()}>
                                Login
                            </span>
                        }
                        ...
                        <span id="header_country" className="btn btn-big">
                            ...
                            <div className="dropdown">
                                <ul>
                                    ...
                                    <li>
                                        <a href="https://zoutons.ae/">
                                            <span>UAE</span>
                                            <img
                                                src="https://cdn.countryflags.com/thumbs/united-arab-emirates/flag-round-250.png"
                    ...
                    <input type="hidden" className="controller_name" value="home" />
                </div>
            </header>
        </>
    );
